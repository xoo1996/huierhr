...
<lemis:body>
<lemis:errors />
<lemis:title title="新增配件" />
	<lemis:tabletitle title="配件信息" />
	<table class="tableinput">
		<lemis:editorlayout />
		<html:form action="/ProductAction.do?method=saveNew&mark=accessory"
			method="POST">
			<tr>
				...
				<lemis:texteditor property="pdtnm" label="商品名称" disable="false"
					required="true" />
				<lemis:texteditor property="pdtkind" label="类别"  value="配件"
				    required="true" />
			...
			<tr>
				...
				<lemis:texteditor property="pdtprc" label="单价" required="true"
					disable="false" />
			   <lemis:texteditor property="pdtclnm" label="商品类别" required="true" disable="false"></lemis:texteditor>
