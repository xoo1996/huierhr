...
<lemis:body>
	...
	<table class="tableinput">
		<lemis:editorlayout />
		<html:form action="/ProductAction.do?method=savePcl"
			method="POST">
			<tr>
				<lemis:texteditor property="pclid" label="商品类别代码" disable="false"
					required="true" />
				<lemis:texteditor property="pcllarge" label="商品大类" disable="false"
					required="true" />
				<lemis:texteditor property="pclmid" label="商品中类" disable="false"
					required="true" />
				<%-- <lemis:codelisteditor type="pclmid" isSelect="true" label="耳机类别"
