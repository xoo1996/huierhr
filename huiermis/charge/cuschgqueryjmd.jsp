...
<%
	...
	header.add(new Formatter("balance", "应收余额", "color:#000000;", TagConstants.DT_MONEY));
...
<script language="javascript">
	function dingzhishoufei(obj) {
		...
		obj.action = '<html:rewrite page="/ChargeAction.do?method=jmdcustomizedChargeDetail&"/>' + getAlldata(obj);
		obj.submit();
	};
...
<lemis:body>
	...
	<lemis:query action="/ChargeAction.do?method=jmdquery&charge=search" editorMeta="editor" topic="查询条件" />	
