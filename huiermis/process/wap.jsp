...
<%
	...
	//header.add(new Formatter("bsc012", "申请人账号",TagConstants.DF_CENTER));
	...
	buttons.put("查看审核记录","verifynem(document.all.tableform)");
	buttons.put("审 核","verifyapa(document.all.tableform)");
	...
	session.setAttribute("tableheader", "待审批流程查询");//表头
...
<html>
	...
	<lemis:base />
	<lemis:body>
		<lemis:title title="待审批流程查询" />
		<lemis:query action="/ApaOperAction.do?method=queryApa&type=verify" editorMeta="editor" topic="待审批流程查询" />
