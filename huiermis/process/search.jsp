...
<%
	...
	session.setAttribute("tableheader", "请假流程查询");//表头
...
<html>
	...
	<lemis:base />
	<lemis:body>
		<lemis:title title="请假流程新建" />
		<lemis:query action="/ApaOperAction.do?method=queryApa&type=rest" editorMeta="editor" topic="员工信息查询" />
