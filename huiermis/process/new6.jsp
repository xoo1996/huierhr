		...
		<html:form action="/ApaOperAction.do?method=saveNewApa&type=user" method="POST">
			...
			<tr>
				<lemis:texteditor property="userdepartmentid" label="所属部门" disable="false" 
					required="true" />
				<lemis:codelisteditor type="positionname" label="岗位" required="true" />			
				<lemis:formateditor mask="date" property="writedate"
						label="填表日期"  required="false" disable="false"/>
			...
			<tr>
					...
					<lemis:codelisteditor type="useremployeestatus" label="员工状态" required="true" />
			...
			<tr>
				...
				<lemis:codelisteditor type="userismarry" label="婚姻状况" required="true"/>
			...
			<table class="tableinput">
				...
				<tr>
					...
					<lemis:codelisteditor type="userhukoutype" isSelect="true" label="户口性质" redisplay="true" required="false" />
				</tr>
				<tr>
					...
					<lemis:texteditor property="userpostcode1" label="邮编"
						disable="false" required="false" maxlength="6"/>
				<lemis:codelisteditor type="usercontype" label="合同类型" required="true" isSelect="true" redisplay="true"/>
				</tr>			
			</table>
			...
			<COLGROUP><COL width='20%'><COL width='15%'><COL width='20%'><COL width='15%'><COL width='20%'><COL width='15%'></COLGROUP>
				<tr>
					...
					<lemis:codelisteditor type="investigate2"
						label="是否与其他企业签订保密、竞业限制协议"  required="true" />
				</tr>
				<tr>
					<lemis:codelisteditor type="investigate3" label="是否与其他单位有未尽法律事宜" required="true" />
					<lemis:codelisteditor type="investigate4" label="是否能接受工作地点调整或频繁出差" required="true"/>
				</tr>
				<tr>
