...
<%
	...
	session.setAttribute("tableheader", "离职流程查看");//表头
...
<html>
	<script language="javascript">
		//审核信息
  		function verifyapa(obj){
			...
			obj.action = '<html:rewrite page="/ApaOperAction.do?method=printApa&type=lzqk&"/>'+getAlldata(obj);			
			obj.submit();
  		}
	</script>
	...
	<lemis:base />
	<lemis:body>
		<lemis:title title="离职流程查看" />
		<lemis:query action="/ApaOperAction.do?method=queryApa&type=lzqk" editorMeta="editor" topic="入职手续情况查询" />
