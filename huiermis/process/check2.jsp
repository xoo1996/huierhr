...
<%
	...
	header.add(new Formatter("userjoindate", "入职时间",TagConstants.DF_CENTER));
	header.add(new Formatter("bsc009", "所属团体",TagConstants.DF_CENTER));
	...
	session.setAttribute("tableheader", "所有流程查询");//表头
...
<html>
	...
	<lemis:base />
	<lemis:body>
		<lemis:title title="所有流程查询" />
		<lemis:query action="/ApaOperAction.do?method=queryApa&type=seak" editorMeta="editor" topic="归档流程查询" />
