	...
	<lemis:body>
		...
		<table class="tableinput">
			...
			<html:form action="/ApaOperAction.do?" method="POST">
				...
				<tr>
					<lemis:texteditor property="nemsoc" label="社保情况" required="true" disable="true" colspan="3"/>
					<lemis:texteditor property="nemif" label="其他约定" required="false" disable="true" />
				</tr>
				</table>
