...
<lemis:base />
<lemis:body>
	<lemis:title title="查看销售明细" />
    <lemis:tabletitle title="销售详细信息" />
    <table class="tableInput">
		<lemis:editorlayout />
		<html:form action="/BusinessAction.do" method="POST">
			<tr>
				<lemis:texteditor property="ivtnote" label="助听器类别" disable="true" />
	...
	<lemis:table topic="销售基本信息" action="/BusinessAction.do"
