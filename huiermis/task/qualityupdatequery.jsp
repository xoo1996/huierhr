...
<%
	...
	buttons.put("质检详情","quality()");
	//buttons.put("退机质检","recoilQA(document.all.tableform)");
...
<script language="javascript">
	...
	function recoilQA(obj) {
		obj.action = '<html:rewrite href="/huiermis/switchAction.do?prefix=/task&page=/recoilQA.jsp"/>';
		obj.submit();
	...
	function quality() {
		...
		window.location.href = "/" + lemis.WEB_APP_NAME
				+ "/task/TaskAction.do?method=quality&tp=update&"
...
<lemis:body>
	...
	<lemis:query action="/TaskAction.do?method=query&order=qualityupdate" editorMeta="editor"
		topic="查询条件" />
