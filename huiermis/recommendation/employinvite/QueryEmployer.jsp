<!--/lemis/recommendation/employinvite/QueryEmployer.jsp-->
...
String url = "";
  ...
  buttons.add(new Button("Btn_next","招聘登记","rec040101","next(document.all.tableform)"));
...
%>
  ...
  <lemis:query action="/Rec04Action.do?method=queryEmployer"  editorMeta="editor" topic="查询条件"/>
  
  <lemis:table topic="单位基本信息" action="/Rec04Action.do" headerMeta="header" hiddenMeta="hidden" 
     mode="radio"/>
   <lemis:buttons buttonMeta="buttons"/>
  
  <lemis:errors/><lemis:clean names="Rec0401Form"/><lemis:clean names="Rec0402Form"/>
...
function next (obj){
    ...
    obj.action= '<html:rewrite page="/Rec0401Action.do?method=initaddEmployInvite&"/>'+getAlldata(obj);
