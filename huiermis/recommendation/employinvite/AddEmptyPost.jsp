<!--/recommendation/employinvite/AddEmptyPost.jsp-->
...
<% 
  ...
  buttons.add(new Button("Btn_save","保 存","rec040209","save()"));
 
  buttons.add(new Button("Btn_back","返 回","rec999997","go2Page(\"recommendation\",\"2\")"));
  buttons.add(new Button("Btn_close","关 闭","rec999999","closeWindow(\"Rec0402DTO,Rec0402Form,addP\")"));
...
%>
  ...
  <lemis:editorlayout/>
  <html:form action="/Rec0402Action.do?method=addEmptyPost" method="POST">
   <tr>
...
function zdgz(){
  ...
  function save(){
   ...
   if (!ok){
    ...
    obj.action= '<html:rewrite page="/Rec0402Action.do?method=saveEmptyPost&"/>';
