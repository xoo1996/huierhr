<!--lemis/recommendation/employassembly/modifyorgancom.jsp-->
...
<% 
  ...
  buttons.add(new Button("Btn_save","保 存","rec080502","addsave(document.forms[0])"));
...
<script src="/lemis/js/lemisTree.js"></script>
  ...
  <lemis:editorlayout/>
   <tr>
	 <lemis:codelisteditor type="acb261" label="类型" required="true" isSelect="true" redisplay="true"/>
	 <lemis:formateditor property="acb262" label='分数' disable="false" mask="nnnn" required="true"/>
   </tr>
   <tr>
      <lemis:texteditor property="acb263" label="原因" maxlength="100"  disable="false" colspan="5"/> 
    </tr>
    <tr>
      <lemis:texteditor property="acb264" label="处理结果" maxlength="100"  disable="false" colspan="5"/> 
    </tr>
      <tr>
   ...
   <script language="javascript">
     function addsave(obj)
     {
      var t  = checkValue(obj);
	   ...
	   obj.action = '<html:rewrite page="/Rec0804Action.do?method=modifyorgancom"/>';
	   obj.submit();
     }
