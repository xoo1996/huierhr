<!--lemis/recommendation/employassembly/vieworganyc.jsp-->
...
<script src="/lemis/js/lemisTree.js"></script>
  ...
  <%//标题部分%>
  <lemis:title title="查看机构年检信息"/>
  <%//录入部分%>
  <html:form action="/Rec0802Action.do" method="POST">
  ...
  <lemis:editorlayout/>
   <tr>
	 ...
	 <lemis:codelisteditor type="acb251" label="年检结果" required="false" isSelect="false" redisplay="true"/>
	 <lemis:formateditor property="acb252" label='工作人员数量' disable="true" mask="nnnn" required="false"/>
   </tr>
   <tr> 
    <lemis:formateditor property="acb253" label='有职介资格人数' disable="true" mask="nnnn" required="false"/>
    <lemis:formateditor property="acb254" label='上年登记岗位数' disable="true" mask="nnnn" required="false"/>
    <lemis:formateditor property="acb255" label='登记人数' disable="true" mask="nnnn" required="false"/>
   </tr>
   <tr>
   <lemis:formateditor property="acb256" label='介绍成功人数' disable="true" mask="nnnn" required="false"/>
   <lemis:texteditor property="acb257" label="微机型号" maxlength="30" disable="true" colspan="3" required="false"/>
   </tr>
   <tr>
   <lemis:formateditor property="acb258" label='微机数量' disable="true" mask="nnnn" required="false"/>
   <lemis:texteditor property="acb259" label="许可证号" maxlength="30" disable="true"  required="false"/>
   <lemis:formateditor property="acb25a" label='市检总分' disable="true" mask="nnnn" required="false"/>
   </tr>
     <tr>
      <lemis:texteditor property="acb25b" label="市、区劳动部意见" maxlength="100"  disable="true" colspan="5"/> 
    </tr> 
    <tr>
      <lemis:texteditor property="acb25c" label="就业服务管理局意见" maxlength="100"  disable="true" colspan="5"/> 
    </tr>  
      <tr>
