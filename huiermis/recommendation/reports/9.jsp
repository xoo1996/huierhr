...
try{
	...
	for(int i=0;i<length;i++)
	{
		String sql1 = "";
		if(i==0)//男
		sql1 = "select nvl(sum(b.acb21d),0) from cb20 a,cb21 b,ab01 c where a.acb200=b.acb200 and a.aab001=c.aab001 and"+
					  " a.aae043<to_date('"+date2+"','yyyy-mm') and a.aae043>=to_date('"+date1+"','yyyy-mm') and b.aac004='1'";
		if(i==1)//女
		sql1 = "select nvl(sum(b.acb21d),0) from cb20 a,cb21 b,ab01 c where a.acb200=b.acb200 and a.aab001=c.aab001 and"+
					  " a.aae043<to_date('"+date2+"','yyyy-mm') and a.aae043>=to_date('"+date1+"','yyyy-mm') and b.aac004='2'";
		if(i==2)//无需求
		sql1 = "select nvl(sum(b.acb21d),0) from cb20 a,cb21 b,ab01 c where a.acb200=b.acb200 and a.aab001=c.aab001 and"+
					  " a.aae043<to_date('"+date2+"','yyyy-mm') and a.aae043>=to_date('"+date1+"','yyyy-mm') and (b.aac004='9' or b.aac004 is null) ";
		...
		String sql2 = "select count(*) from cc20 b, ac01 a where a.aac001=b.aac001 and "+
		              "  b.aae043<to_date('"+date2+"','yyyy-mm') and b.aae043>=to_date('"+date1+"','yyyy-mm')";
		if(i==0)//男
		sql2+=" and a.aac004 ='1'";
		if(i==1)//女
		sql2+=" and a.aac004 ='2'";
		if(i==2)//无需求
		sql2+=" and (a.aac004 ='9' or a.aac004 is null)";
...
<div align="center">
  <table width="905" border="0">
    <tr>
      <td align="center" colspan="2"><span class="title">表9：按性别分组的供求人数</span></td>
    </tr>
    <tr>
