<!--/recommendation/employassembly/ModEmployInvite.jsp-->
...
<% 
  ...
  buttons.add(new Button("Btn_save", "保 存", "rec070204", "save()"));
  buttons.add(new Button("Btn_back", "返 回", "rec999997", "go2Page(\"recommendation\",\"1\")"));
  buttons.add(new Button("Btn_close", "关 闭", "rec999999", "closeWindow(\"modE,Rec0702Form\")"));
...
%>
  ...
  <lemis:editorlayout/>
  <html:form action="/Rec0702Action.do?method=modEmployInvite" method="POST">
  <tr>
  ...
  <lemis:editorlayout/>
  <tr>
       <lemis:texteditor property="acb231" label="大会招聘期数" maxlength="20" disable="true" required="true" />
    ...
    <tr>
      <lemis:codelisteditor type="acb201" label="招聘方式"  isSelect="false"  key="2" redisplay="true" required="false" />
...
<script language="javascript" >
  ...
  function save(){
    ...
    obj.action= '<html:rewrite page="/Rec0702Action.do?method=modsaveEmployInvite"/>';
    obj.submit();
  }
  // 判断日前的先后顺序
