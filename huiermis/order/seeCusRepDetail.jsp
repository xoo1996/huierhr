	...
	<table class="tableInput">
		...
		<lemis:tabletitle title="左耳骨导" />
           ...
           <tr>
			    ...
			    <lemis:texteditor property="gctnm" label="送修单位" disable="true"></lemis:texteditor>
				<html:hidden property="folctid"/>
				<lemis:texteditor property="foldt" label="经办日期"></lemis:texteditor>
				</tr>
				<tr>
				  <html:hidden property="repfolid"/>
				  <lemis:codelisteditor type="repclear" label="是否已清洁" isSelect="false"></lemis:codelisteditor>
		   ...
		   <lemis:tabletitle title="维修信息" />
            ...
            <lemis:editorlayout />
            <tr>
            <lemis:codelisteditor type="repsymptom" label="故障现象" isSelect="false"></lemis:codelisteditor>
           <lemis:codelisteditor type="repshellsyp" label="故障现象：（耳道机外壳）" isSelect="false"></lemis:codelisteditor>
<%--            <lemis:textareaeditor colspan="1" rowspan="2" property="repotsyp" label="其他故障现象和客户要求"></lemis:textareaeditor> --%>
                <lemis:texteditor property="repotsyp" label="其他故障现象和客户要求" disable="true"></lemis:texteditor>
            </tr>
            <tr>
     
            <lemis:codelisteditor type="reppossyp" label="外壳疼痛或胀，请标明位置" isSelect="false"></lemis:codelisteditor>
            <lemis:codelisteditor type="repfree" label="是否在保修期内" isSelect="false"></lemis:codelisteditor>
            <lemis:texteditor property="reptime" label="第几次维修" disable="true"></lemis:texteditor>
            </tr>
            <tr>
            <%-- <lemis:codelisteditor type="reppreamt" label="维修费超过" isSelect="false"></lemis:codelisteditor>--%>
            <lemis:texteditor property="reppreamt" label="维修费超过（元）" disable="true"></lemis:texteditor>
            <lemis:codelisteditor type="repcpy" isSelect="false" label="送修厂商" redisplay="true" required="true" />
