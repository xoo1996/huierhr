...
<script language="javascript">
	function saveData(obj) {
		...
		if (document.all("tmecls").value == 'new'
				|| document.all("tmecls").value == 'redo') {
...
<script language="javascript">
	...
	function commit(obj) {
		...
		obj.action = '<html:rewrite href="/huiermis/order/OrderAction.do?method=modifyEarRep&tp=c"/>';
...
function save(obj) {
	...
	obj.action = '<html:rewrite href="/huiermis/order/OrderAction.do?method=modifyEarRep&tp=b"/>';
			...
			<table class="tableinput">
				...
				<tr>
					<%-- <lemis:codelisteditor type="tmefree" isSelect="true" label="是否赠送"
						redisplay="true" required="true" /> --%>
					<lemis:codelisteditor type="fdtcls" label="制作类别" required="true" isSelect="false"
						></lemis:codelisteditor>
