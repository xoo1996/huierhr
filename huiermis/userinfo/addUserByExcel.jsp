...
<lemis:body>
	...
	<lemis:title title="excel表导入员工数据" />
		基本信息
		<html:form enctype="multipart/form-data" action="/UserInfoAction.do?method=addUserByExcel" method="post">  
		...
		家庭情况
		<html:form enctype="multipart/form-data" action="/UserInfoAction.do?method=addFamilyByExcel" method="post">  
          <input type="file" id="file_0" name="file[0]" /> </span>  
          <html:submit>&nbsp;&nbsp;上传&nbsp;&nbsp;</html:submit>  
		</html:form> 
		培训情况
		<html:form enctype="multipart/form-data" action="/UserInfoAction.do?method=addTrainByExcel" method="post">  
          <input type="file" id="file_0" name="file[0]" /> </span>  
          <html:submit>&nbsp;&nbsp;上传&nbsp;&nbsp;</html:submit>  
		</html:form> 
		工作情况
		<html:form enctype="multipart/form-data" action="/UserInfoAction.do?method=addWorkByExcel" method="post">  
          <input type="file" id="file_0" name="file[0]" /> </span>  
          <html:submit>&nbsp;&nbsp;上传&nbsp;&nbsp;</html:submit>  
		</html:form> 
		上下级配置
		<html:form enctype="multipart/form-data" action="/UserInfoAction.do?method=addSupByExcel" method="post">  
          <input type="file" id="file_0" name="file[0]" /> </span>  
          <html:submit>&nbsp;&nbsp;上传&nbsp;&nbsp;</html:submit>  
		</html:form>
      	账号-员工id导入
		<html:form enctype="multipart/form-data" action="/UserInfoAction.do?method=addAccByExcel" method="post">  
          <input type="file" id="file_0" name="file[0]" /> </span>  
          <html:submit>&nbsp;&nbsp;上传&nbsp;&nbsp;</html:submit>  
		</html:form>
