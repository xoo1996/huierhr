...
<lemis:body>
	...
	<COLGROUP><COL width='10%'><COL width='15%'><COL width='10%'><COL width='15%'><COL width='10%'><COL width='15%'><COL width='10%'><COL width='15%'></COLGROUP>
		<html:form action="/UserInfoAction.do?method=addUser" method="POST">
			
			<tr>
				<lemis:texteditor property="userdepartmentid" label="所属部门" disable="false" 
					required="true" />
				<lemis:codelisteditor type="positionname" label="岗位" required="true" isSelect="true" redisplay="true"/>			
				<lemis:formateditor mask="date" property="writedate"
						label="填表日期"  required="false" disable="true"/>
				<lemis:texteditor property="danganid" label="档案号" required="false"
			...
			<tr>
				...
				<lemis:codelisteditor type="usergender" label="性别" required="true" isSelect="true" redisplay="true"/>
				<lemis:codelisteditor type="usernation" label="民族" required="false" isSelect="true" redisplay="true"/>
			...
			<tr>
					<lemis:formateditor mask="date" property="userjoindate"
						label="入职日期" format="true" required="true" disable="false"/>
					<lemis:formateditor mask="date" property="userworktime"
						label="参加工作时间" format="true" required="true" disable="false"/>
					<lemis:codelisteditor type="useremployeestatus" label="员工状态" required="true" isSelect="true" redisplay="true"/>
			...
			<tr>
				...
				<lemis:codelisteditor type="userismarry" label="婚姻状况" required="true" isSelect="true" redisplay="true"/>
				<lemis:texteditor property="userchildno" label="子女数"
			...
			<lemis:formateditor mask="date" property="usergraduatedate"
				label="毕业时间" format="true" disable="false" required="true" />
			<lemis:codelisteditor type="userheightestedu" label="最高学历" required="true"  isSelect="true" redisplay="true"/>
			<lemis:texteditor property="usermajor" label="专业" disable="false" required="false" maxlength="100" />
			<tr>
				<lemis:codelisteditor type="userpolitical" label="政治面貌" required="false" isSelect="true" redisplay="true"/>
			...
			<table class="tableinput">
				...
				<tr>
					...
					<lemis:codelisteditor type="userhukoutype" label="户口性质"  required="false" isSelect="true" redisplay="true"/>
				</tr>
				<tr>
			...
			<table class="tableinput">
				<COLGROUP><COL width='10%'><COL width='15%'><COL width='10%'><COL width='15%'><COL width='10%'><COL width='15%'><COL width='10%'><COL width='15%'></COLGROUP>
				<tr>
					<lemis:texteditor property="emepername" label="紧急联系人" required="true" disable="false" maxlength="20" />
			...
			<COLGROUP><COL width='20%'><COL width='15%'><COL width='20%'><COL width='15%'><COL width='20%'><COL width='15%'></COLGROUP>
				<tr>
					<lemis:codelisteditor type="investigate1" label="是否有亲属在本公司工作"
						required="true" isSelect="true" redisplay="true"/>
					<lemis:codelisteditor type="investigate2"
						label="是否与其他企业签订保密、竞业限制协议"  required="true" isSelect="true" redisplay="true"/>
				</tr>
				<tr>
					<lemis:codelisteditor type="investigate3" label="是否与其他单位有未尽法律事宜" required="true" isSelect="true" redisplay="true"/>
					<lemis:codelisteditor type="investigate4" label="是否能接受工作地点调整或频繁出差" required="true" isSelect="true" redisplay="true"/>
				</tr>
				<tr>
			...
			<%-- 	<tr>
					<lemis:texteditor property="userbelong" label="隶属" required="false" disable="false" maxlength="80" />
					<lemis:texteditor property="userpositionnow" label="现任岗位"
					required="false" disable="false" maxlength="80" />
					<lemis:texteditor property="departmentname" label="所属部门"
						required="false" disable="false" maxlength="80" />
					<lemis:texteditor property="departmenttype" label="部门类型"
						required="false" disable="false" maxlength="80" />
				</tr>
				<tr>
					<lemis:formateditor mask="date" property="contrctstartdate"
						label="合同开始日期" format="true" required="false" disable="false" />
					<lemis:texteditor property="contracttime" label="合同时间"
						required="false" disable="false" maxlength="80" />
					<lemis:formateditor mask="date" format="true" 
						property="contrctenddate" label="合同到期时间" required="false" disable="false" />
					<lemis:texteditor property="worktime" label="本公司工龄"
						required="false" disable="false" maxlength="80" />
				</tr>
			</table> --%>
	<%--  		
	 	...
	 	<jsp:includepage="educate.jsp" />
	 		
		<lemis:table topic="家庭情况"
		action="/UserInfoAction.do" headerMeta="header"
		mode="checkbox" batchInputMeta="batchInput" orderResult="false"
		 batchInputType="insert" pilot="false" pageSize="5" />
		  
		
		<lemis:table topic="教育经历"
		action="/UserInfoAction.do" headerMeta="header2"
		mode="checkbox" batchInputMeta="batchInput2" orderResult="false"
		 batchInputType="insert" pilot="false"  pageSize="5"/>
