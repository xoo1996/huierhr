...
this._id;this._tagId;this.checkboxName;this.face = 0;this.label;this.noPartly = false;this.disabled = false;this.guiNochange = false;this.caption;this.imgDir = '/_bsJavascript/components/checkbox/img/win2k/';this.imgWidth  = '20';this.imgHeight = '20';this.imgStyle = '';this.useMouseover = false;this.eventOnClick;this.eventOnChange;this._constructor = function() {
this._id = Bs_Objects.length;Bs_Objects[this._id] = this;this._tagId = "Bs_Checkbox_"+this._id+"_";}
this.render = function(tagId) {
if (this.noPartly && (this.face == 1)) this.face = 2;if (!bs_isEmpty(tagId)) {
this._tagId = tagId;}
var out  = new Array();var outI = 0;var img = '';img += (this.disabled) ? 'disabled' : 'enabled';img += '_' + this.face;if (!this.disabled) {
...
out[outI++] = '<input face="' + this.face+'" value="' + this.title + ';' + this.face+ '" type=checkbox name="' + 'function' + '" id="' + this.checkboxName + '" style="display:none; visibility:hidden;"';if (this.face) out[outI++] = ' checked';out[outI++] = '>';return out.join('');}
...
var img = document.getElementById(this._tagId + 'icon');img.src = img['swapOut' + this.face].src;}
this.onClick = function() {
switch (this.face) {
case 0:
this.face = 2;break;case 1:
case 2:
this.face = 0;this.face = 0;break;default:
this.face = 0;}
...
this.face = value;this._updateHiddenField();this._updateIcon();if (!cancelEventOnChange) {
...
var img = '';img += (this.disabled) ? 'disabled' : 'enabled';img += '_' + this.face;iconElm.src = this.imgDir + img + '.gif';}
}
this._updateHiddenField = function() {
var elm = document.getElementById(this.checkboxName);
elm.face = this.face;
elm.value=this.label+";"+elm.face;
elm.checked = (this.face);}
this._constructor();}
