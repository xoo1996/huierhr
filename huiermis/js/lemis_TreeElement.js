...
var checkboxSpan = this.checkboxName + 'Span';var checkboxObj  = this.checkboxName + 'Obj';out[outI++] = '&nbsp;<span id="' + checkboxSpan + '">';var t = new Bs_Checkbox();t.objectName = checkboxObj;t.title=this.functionid;t.label=t.title;t.checkboxName = this.checkboxName;t.face = this.isChecked;if (this._getVar('checkboxSystemGuiNochange')) {
t.guiNochange = true;}
...
t.attachOnClick('Bs_Objects['+this._tree._id+'].elementCheckboxEvent(\'' + this.id + '\', ' + checkboxObj + '.face);');}
...
this.reset = function() {
this.caption           = null;this.url               = null;this.functionid=null;this.target            = null;this.onClick           = null;this.isOpen            = false;this.isChecked         = 0;this.checkboxName      = null;this.beforeIconSpan    = null;this.beforeCaptionSpan = null;this.afterCaptionSpan  = null;}
...
if (typeof(a['functionid'])             != 'undefined') this.functionid             = a['functionid'];
...
img.src = img['swapOver' + this.face].src;}
this.onMouseOut = function() {
var img = document.getElementById(this._spanId + 'icon');img.src = img['swapOut' + this.face].src;}
this.setCheckboxValue = function(face, fireEvents, doWalk) {
...
this.isChecked = face;this._checkboxObject.setTo(face, true);if (fireEvents) {
...
if ((this._tree.checkboxSystemWalkTree == 3) || (this._tree.checkboxSystemWalkTree == 2) || ((this._tree.checkboxSystemWalkTree == 4) && (face == 0))) {
this.checkboxUpdateDown(face);}
}
}
this.checkboxEvent = function(face) {
if (!this.hasChildren()) {
face = (face) ? 2 : 0;} else {
if (this.isChecked == 1) {
...
this.isChecked = face;this._checkboxObject.setTo(face, true);if (this.hasEventAttached('onChangeCheckbox')) this.fireEvent('onChangeCheckbox');if ((this._tree.checkboxSystemWalkTree == 3) || (this._tree.checkboxSystemWalkTree == 1) || (this._tree.checkboxSystemWalkTree == 4)) {
this.parent.updateCheckboxFromChild();}
if ((this._tree.checkboxSystemWalkTree == 3) || (this._tree.checkboxSystemWalkTree == 2) || ((this._tree.checkboxSystemWalkTree == 4) && (face == 0))) {
this.checkboxUpdateDown(face);}
}
this.checkboxUpdateDown = function(face) {
for (var i=0; i<this._children.length; i++) {
this._children[i]._updateCheckboxFromParent(face, true);}
}
