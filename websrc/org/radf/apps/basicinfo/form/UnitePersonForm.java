/**
 * UnitePersonForm.java 2008/03/24
 * 
 ...
 * 个人合并
 */
public class UnitePersonForm extends ActionForm{
		...
		private String oldaac001; //被合并人员内码
		private String newaac001; //目标合并人员内码
		
		private String a002ac;  //目标合并人员页面的身份证号
		private String a003ac;  //....姓名
		
		private String tac001; //主键 别名
		...
		public String getTac001() {
			return tac001;
		}
		public void setTac001(String tac001) {
			this.tac001 = tac001;
		}
