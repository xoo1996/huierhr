 ...
 * 职业综合信息查询
 */
public class Rec03Form extends ActionForm {

	private String aab003;// 组织机构代码

	private String aac001;// 人员编号

	private String aae030;// 招聘开始日期范围：从

	private String acb208;// 求职状态

	private String a030ae;// 至

	private String aab004;// 单位名称

	private String aae043;// 登记日期从

	private String a043ae;// 到

	private String acb21h;// 工资待遇

	private String acb216;// 工种描述

	private String acb21d;// 人数

	private String acb221;// 最低年龄

	private String acb222;// 最高年龄

	private String aac011;// 文化程度

	private String acb210;// 空岗编号
	...
	private String aca111;// 岗位工种

	private String acc01g;// 所学专业

	private String nnn001;// 年龄从

	private String nnn002;// 到
	...
	private String aca112;// 求职工种

	private String aac010;// 户口所在区

	private String bac299;// 人员类别

	private String acc222;// 推荐机构

	private String aac048;// 用工形式

	private String a031ae;// 到

	private String acc220;// 职介号

	private String acc223;// 求职状态

	private String ace014;// 推荐日期

	private String ace005;// 求职者电话
    ...
    private String aab019;//单位性质
	private String aab020;//经济类型
	private String aab054;//行业类别
	private String aac013;//用工形式
	private String acb217;//招聘范围
	...
	public String getA031ae() {
		return a031ae;
	}

	public void setA031ae(String a031ae) {
		this.a031ae = a031ae;
	}
	...
	public String getAcc222() {
		return acc222;
	}

	public void setAcc222(String acc222) {
		this.acc222 = acc222;
	}
	...
	public String getA030ae() {
		return a030ae;
	}

	public void setA030ae(String a030ae) {
		this.a030ae = a030ae;
	}
