...
public class ModifyTransAction extends ActionSupport{
    private String className = this.getClass().getName();


  /**
   * 调用TransFacade.modifyTrans()
   */
    public EventResponse perform(Event evt){
        ...
        try {
            ...
            // 调用对应的Facade业务处理方法
            ResponseEnvelop resEnv = facade.modifyTrans(value);
    ...
    protected Object processBody(HashMap hashBody) throws ManageInputException {
        ...
        String transName =  TypeCast.stringToString((String)hashBody.get("transName"),"交易名称",true);
        String transDesc =  TypeCast.stringToString((String)hashBody.get("transDesc"),"交易描述",true);
        int iTimeOut =  TypeCast.stringToInt((String)hashBody.get("timeOut"),"超时时间",false);
        String transType =  TypeCast.stringToString((String)hashBody.get("transType"),"交易类型",false);
        String undoTransId =  TypeCast.stringToString((String)hashBody.get("undoTransId"),"反向交易ID",true);
        String redoTransId =  TypeCast.stringToString((String)hashBody.get("redoTransId"),"重做交易ID",true);
