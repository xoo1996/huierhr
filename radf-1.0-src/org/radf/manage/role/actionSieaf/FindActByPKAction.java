...
public class FindActByPKAction extends ActionSupport{
    private String className = this.getClass().getName();

	public FindActByPKAction() {
	}
	/**
	 *调用AclFacade.findActByPK()
	 */
	public EventResponse perform(Event evt) {
        ...
        try {
            ...
            //调用对应的Facade业务处理方法
            ResponseEnvelop resEnv = facade.findActByPK(value);
    ...
    protected Object processBody(HashMap hashBody)throws ManageInputException{
		String inPara = TypeCast.stringToString((String) hashBody.get("actID"),"actID",false);
		return new SysAct(inPara);
	}
    /**
