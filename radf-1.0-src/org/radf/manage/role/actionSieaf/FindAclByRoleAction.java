 ...
 * 用roleid对应的ACL记录
 */
public class FindAclByRoleAction extends ActionSupport{
    private String className = this.getClass().getName();

	public FindAclByRoleAction() {
	}
	/**
	 *调用AclFacade.findAclByRole()
	 */
    public EventResponse perform(Event evt) {
        ...
        try {
            ...
            //调用对应的Facade业务处理方法
            ResponseEnvelop resEnv = facade.findAclByRole(value);
    ...
    protected Object processBody(HashMap hashBody)throws ManageInputException{
		String inPara = TypeCast.stringToString((String) hashBody.get("roleID"),"roleID",false);
		return new SysRole(inPara);
	}
    /**
    ...
    protected HashMap processMap(Object resBody){
		...
		for (Iterator iter = collection.iterator(); iter.hasNext();) {
			SysAcl dto = (SysAcl) iter.next();

			HashMap row = new HashMap();
			row.put("functionID", (String) dto.getFunctionID());
			row.put("aclID", (String) dto.getAclID());
			list.add(row);
		}
		body.put("allAcls", list);
		return body;
	}
}
