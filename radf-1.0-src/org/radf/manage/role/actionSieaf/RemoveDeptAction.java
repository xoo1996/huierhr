 ...
 * 删除SYSDEPT记录
 */
public class RemoveDeptAction extends ActionSupport{
    private String className = this.getClass().getName();
    /**
     * 调用RoleFacade.removeDept()
     */
    public EventResponse perform(Event evt){
        ...
        try {
            ...
            //调用对应的Facade业务处理方法
            ResponseEnvelop resEnv = facade.removeDept(value);
    ...
    protected Object processBody(HashMap hashBody)throws ManageInputException{
        String PK = (String)hashBody.get("org");
        return PK;
    }
    /**
