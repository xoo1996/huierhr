 ...
 * 用主键查找指定ACL记录
 */
public class FindAclByPKAction extends ActionSupport{
    private String className = this.getClass().getName();

	public FindAclByPKAction() {
	}
	/**
	 *调用AclFacade.findAclByPK()
	 */
    public EventResponse perform(Event evt) {
        ...
        try {
            ...
            //调用对应的Facade业务处理方法
            ResponseEnvelop resEnv = facade.findAclByPK(value);
    ...
    protected Object processBody(HashMap hashBody)throws ManageInputException{
		String inPara = TypeCast.stringToString((String) hashBody.get("aclID"),"aclID",false);
        
		return new SysAcl(inPara);
	}
    /**
