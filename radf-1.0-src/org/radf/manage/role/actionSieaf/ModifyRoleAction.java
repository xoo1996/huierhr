...
public class ModifyRoleAction extends ActionSupport{
	...
	/**
	 * 调用RoleManagerFacade.modifyRole()
	 */
	public EventResponse perform(Event evt) {
        ...
        try {
            ...
            //调用对应的Facade业务处理方法
            ResponseEnvelop resEnv = facade.modifyRole(value);
    ...
    protected Object processBody(HashMap hashBody)throws ManageInputException{
		...
		sysRole.setRoleDesc(TypeCast.stringToString((String) hashBody.get("roleDesc"),"角色描述",true));
		sysRole.setRoleID(TypeCast.stringToString((String) hashBody.get("roleID"),"角色id",false));

		if (sysRole.getRoleDesc().length() > 30)
			throw new ManageInputException("角色描述长度必须少于30位");
		return sysRole;
	}
    /**
