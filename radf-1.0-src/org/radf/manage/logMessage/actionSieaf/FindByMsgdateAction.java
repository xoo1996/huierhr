...
/**
 * <p>Title: 根据日志时间范围查询</p>
 * @author zqb</a>
 * @version 1.0
 */

public class FindByMsgdateAction extends ActionSupport{
    private String className = this.getClass().getName();

    /**
     * 调用LogFacade.findByMsgdate
     * @param evt
     * @return
     */
    public EventResponse perform(Event evt){
        ...
        try {
            ...
            //调用对应的Facade业务处理方法
            ResponseEnvelop resEnv = facade.findByMsgdate(value);
    ...
    protected Object processBody(HashMap hashBody)throws ManageInputException{
      //check param
      String beginmsgdate=TypeCast.stringToString(
          (String)hashBody.get("beginmsgdate"),"日志起始时间",false);
      String endmsgdate=TypeCast.stringToString(
          (String)hashBody.get("endmsgdate"),"日志终止时间",true);
      ...
      reqbody.put("beginmsgdate",beginmsgdate);
      reqbody.put("endmsgdate",endmsgdate);
