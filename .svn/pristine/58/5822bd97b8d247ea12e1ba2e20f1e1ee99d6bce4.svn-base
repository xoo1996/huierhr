...
public class Rec0201Form extends ActionForm {
	...
	private String bae120;// 个人状态

	private String bkc020;// 社会保险编号

	private String cce001;// 所属街区代码

	// cc20

	private String aac038;// 第一外语

	private String aac039;// 第一外语熟练程度

	private String aac041;// 第二外语

	private String aac042;// 第二外语熟练程度

	private String aac043;// 计算机水平
	...
	private String acb208;// 求职状态

	private String acb20e;// 推荐成功日期

	private String acc200;// 求职编号

	private String acc201;// 登记类别

	private String acc207;// 是否境外求职

	private String acc20b;// 信息采集员

	private String acc20e;// 其它外语

	private String ace014;// 有效截止日期
	...
	private String acb21s;// 保险要求

	private String acc034;// 工资待遇

	private String acc210;// 择业工种编号

	private String acc211;// 单位性质要求

	private String acc212;// 用工形式要求

	private String acc213;// 求职地区要求

	private String acc214;// 报酬福利要求

	//

	private String aca111a;// 意向2代码

	private String aca111b;// 意向3代码

	private String aca112a;// 意向2

	private String aca112b;// 意向3

	private String acc210a;// 求职则业编号2

	private String acc210b;// 求职则业编号3
	...
	public String getAca111a() {
		return aca111a;
	}

	public void setAca111a(String aca111a) {
		this.aca111a = aca111a;
	}

	public String getAca111b() {
		return aca111b;
	}

	public void setAca111b(String aca111b) {
		this.aca111b = aca111b;
	}
	...
	public String getAca112a() {
		return aca112a;
	}

	public void setAca112a(String aca112a) {
		this.aca112a = aca112a;
	}

	public String getAca112b() {
		return aca112b;
	}

	public void setAca112b(String aca112b) {
		this.aca112b = aca112b;
	}
	...
	public void setAcb20e(String acb20e) {
		this.acb20e = acb20e;
	}
	...
	public String getAcb21s() {
		return acb21s;
	}

	public void setAcb21s(String acb21s) {
		this.acb21s = acb21s;
	}
	...
	public String getAcc210a() {
		return acc210a;
	}

	public void setAcc210a(String acc210a) {
		this.acc210a = acc210a;
	}

	public String getAcc210b() {
		return acc210b;
	}

	public void setAcc210b(String acc210b) {
		this.acc210b = acc210b;
	}
	...
	public void setAcc211(String acc211) {
		this.acc211 = acc211;
	}

	public String getAcc212() {
		return acc212;
	}

	public void setAcc212(String acc212) {
		this.acc212 = acc212;
	}
	...
	public void setAce014(String ace014) {
		this.ace014 = ace014;
	}
	...
	public String getBae120() {
		return bae120;
	}

	public void setBae120(String bae120) {
		this.bae120 = bae120;
	}
