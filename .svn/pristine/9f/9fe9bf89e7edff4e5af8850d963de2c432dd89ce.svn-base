...
<script language="javascript">
	function modify(obj) {
		...
		obj.action = '<html:rewrite page="/GroupClientAction.do?method=modify&"/>' + getAlldata(obj);
		obj.submit();
	};
	function deleteci(obj) {
		...
		obj.action = '<html:rewrite page="/GroupClientAction.do?method=delete&"/>' + getAlldata(obj);
        if(confirm("确定要删除该团体信息吗？"))
		{
    		obj.submit();
		}
	}
...
<lemis:body>
	...
	<lemis:query action="/GroupClientAction.do?method=query&order=modify"
