...
<lemis:body>
    ...
    <lemis:title title="本人档案信息" />
    <table class="tableinput">
				<COLGROUP><COL width='12%'><COL width='15%'><COL width='10%'><COL width='14%'><COL width='10%'><COL width='40%'></COLGROUP>
			</table>
	<lemis:query action="/UserInfoAction.do?method=querySingleInfo" editorMeta="editor" topic="登录账号" />	
	<lemis:table action="UserInfoAction.do" headerMeta="header" topic="个人信息" 
