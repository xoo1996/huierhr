  ...
  * @version 1.0
  */
package org.radf.apps.recommendation.employinvite.form;

import org.apache.struts.action.ActionForm;
/**
 * 委托招聘岗位信息管理
 */
public class Rec0402Form extends ActionForm {
	...
	private String acb207;// 面试日期

	private String acb209;// 收费金额
	...
	private String acb20e;// 注销日期

	private String acb210;// 空位编号

	private String acb211;// 委托招聘人数
	...
	private String acb21a;// 已成功人数

	private String acb21c;// 是否招收外来人员

	private String acb21d;// 允许人数

	private String acb21g;// 社会保险情况

	private String acb21h;// 劳动报酬

	private String ac21hb;// 劳动报酬最低限制

	private String acb21i;// 工资待遇说明

	private String acb221;// 最小年龄

	private String acb222;// 最大年龄

	private String acb228;// 是否提供食宿

	private String bac299;// 求职人员类别

	private String acb21o;// 推荐比例

	private String aaeyxq;// 招聘有效期间隔时间天数

	public String getAaeyxq() {
		return aaeyxq;
	}

	public void setAaeyxq(String aaeyxq) {
		this.aaeyxq = aaeyxq;
	}
	...
	public void setAcb221(String acb221) {
		this.acb221 = acb221;
	}
	...
	public void setAcb222(String acb222) {
		this.acb222 = acb222;
	}
	...
	public String getAcb21o() {
		return acb21o;
	}

	public void setAcb21o(String acb21o) {
		this.acb21o = acb21o;
	}
	...
	public String getAc21hb() {
		return ac21hb;
	}

	public void setAc21hb(String ac21hb) {
		this.ac21hb = ac21hb;
	}
