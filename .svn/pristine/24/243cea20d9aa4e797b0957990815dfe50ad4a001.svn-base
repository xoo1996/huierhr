<!-- recommendation/personguidance/edit.jsp -->
...
<%
	...
	buttons.add(new Button("Btn_save", "修 改", "rec050108","saveData(document.forms[0])"));
...
<lemis:body>
	<lemis:errors />
	<lemis:title title="个人指导修改" />
	<html:form action="/Rec05Action.do" method="POST">
		<lemis:tabletitle title="个人指导修改" />
		<table class="tableInput">
			...
			<tr>
				<lemis:formateditor mask="date" property="acc231" label="指导日期"	disable="false" required="true" format="true" />
			...
			<tr>
				<lemis:texteditor property="acc237" label="职业培训情况" disable="false" maxlength="100" colspan="5" maxlength="100"/>
...
<script language="javascript" >
	...
	obj.action ="/" + lemis.WEB_APP_NAME + "/recommendation/Rec05Action.do?method=edit&";
	obj.submit();
	}
