...
<script language="javascript">	
	...
	function add() {
		...
		+ "/order/OrderAction.do?method=printClient&tp=ear&"
		+ getAlldata(document.all.tableform);
	}; 
	
	function addClient(obj) {
		window.location.href = "/" + lemis.WEB_APP_NAME
		+ "/order/CustomOrderAction.do?method=forwardClient&tp=ear&ictnm=" + $("input[name=ictnm]").val();
	}; 
</script>
...
<lemis:body>
	...
	<lemis:query action="/CustomOrderAction.do?method=queryClient&tp=ear"
