<!--/recommendation/employassembly/ViewEmptyPost.jsp-->
...
<%
  ...
  buttons.add(new Button("Btn_close","关 闭","rec999999","closeWindow(\"viewP,Rec0702Form\")"));
...
%>
  ...
  <lemis:editorlayout/>
  <html:form action="/Rec0702Action.do?method=modEmptyPost" method="POST">
<tr>
