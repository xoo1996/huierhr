...
//个人基本信息表$bas
public class Ac01 extends EntitySupport {
    ...
    private BigDecimal aac034;//身高(cm)

    private BigDecimal aac035;//体重(kg)
    ...
    public void setAac007(Date aac007) {
        this.aac007 = aac007;
    }
    ...
    public BigDecimal getAac035() {
        return this.aac035;
    }

    public void setAac035(BigDecimal aac035) {
        this.aac035 = aac035;
    }
