...
<%
   ...
   /*  header.add(new Formatter("repfolid", "订单号")); */
    header.add(new Formatter("reppnm","零件名称"));
    header.add(new Formatter("component", "零件批次"));
	header.add(new Formatter("repgctnm", "客户名称"));
	header.add(new Formatter("repcltnm", "用户姓名"));
	header.add(new Formatter("repid", "机身编号"));
	header.add(new Formatter("reppnl", "面板编号"));
	...
	editors.add(new Editor("text","reppid", "零件代码"));
	editors.add(new Editor("text","reppnm", "零件名称"));
	/*  editors.add(new Editor("text","reppnl", "面板编号")); */
    editors.add(new Editor("text","component", "零件批号"));
   /*  editors.add(new Editor("text","repconfirmed", "故障确认"));
    editors.add(new Editor("text","repactionzh", "维修措施")); */
	/* editors.add(new Editor("date","start", "任务单日期从"));
	editors.add(new Editor("date","end", "到"));  */
...
<lemis:base />
<lemis:body>
	<lemis:title title="零件使用记录查询" />
	<lemis:query action="/RepairAction.do?method=query&order=pgljquery" editorMeta="editor"
		topic="查询条件" />
