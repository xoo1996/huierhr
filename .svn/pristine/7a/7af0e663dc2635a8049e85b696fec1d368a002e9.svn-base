...
<lemis:body>
	<lemis:base />
    <lemis:title title="新增用户详情" />
	<lemis:tabletitle title="用户信息" />
	<table class="tableinput">
		<lemis:editorlayout />
		<html:form action="/ChargeAction.do?method=addClient"method="POST">
			
			<tr>
				<lemis:texteditor property="ictnm" label="用户名称" disable="false"
					required="true" />
			...
			<tr>
				<lemis:texteditor property="ictdetailaddr" label="详细地址" disable="false"
					required="true" />
				<lemis:texteditor property="ictpnm" label="家长姓名" disable="false"
					required="false" />
				<lemis:texteditor property="ictphone" label="手机" disable="false"
					 />
			</tr>
			<tr>
				<lemis:texteditor property="ictlandline" label="固定电话"
					disable="false"  />
			
				<lemis:codelisteditor type="ictphis" label="使用过何种助听器"></lemis:codelisteditor> 
				<lemis:texteditor property="ictnt" label="备注" required="false"
					disable="false" maxlength="80" colspan='3' />
			</tr>
