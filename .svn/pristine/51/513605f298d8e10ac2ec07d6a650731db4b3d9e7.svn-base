...
<%
	...
	buttons.put("同意续签","verifyapa(document.forms[0])");
	buttons.put("拒绝续签","backapa(document.forms[0])");
		...
		<table class="tableinput">
			...
			<html:form action="/ApaOperAction.do?" method="POST">
				...
				<tr>
					...
					<lemis:texteditor property="nemlimit" label="合同期限" required="false" disable="true" />
