...
<%
	...
	buttons.put("开始制作","batchConfirm(document.all.tableform)");
...
<script language="javascript">
	...
	function batchConfirm(obj) {
		...
		if (confirm("确实要确认订单并开始制作耳模吗？")) {
			window.location.href = "/" + lemis.WEB_APP_NAME
					+ "/earmould/EarMouldAction.do?method=updateProduce&"
...
<lemis:body>
	...
	<lemis:query action="/EarMouldAction.do?method=query&order=execute"
