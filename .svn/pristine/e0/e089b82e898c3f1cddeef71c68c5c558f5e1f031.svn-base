...
/**
 * <p>Title: 空值标志类</p>
 * <p>Description: 因为Java中的基本类型没有null值，在这里设置了int、double、long的特殊值， 作为这些基本类型的空值标志</p>
...
public class NullFlag {
    ...
    /** short 空值标志值：-2^15 */
    public static final short SHORTNULL = -32768;
     ...
     * @return
     */
    public static boolean isShortNull(short shortPara) {
        if (shortPara == SHORTNULL)
            return true;
        else
            return false;
    }
    ...
    public static boolean isStringNull(String strPara) {
