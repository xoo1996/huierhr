<!--lemis/recommendation/ownpintorgan/addorganyearcheck.jsp-->
   ...
   <script language="javascript">
     function addsave(obj)
     {
      var t  = checkValue(obj);
	   ...
	   obj.action = '<html:rewrite page="/Rec0802Action.do?method=saveorganyc"/>';
	   obj.submit();
     }
