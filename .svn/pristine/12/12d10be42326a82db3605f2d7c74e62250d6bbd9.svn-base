...
<%
  ...
  List buttons=new ArrayList();//定义按钮属性
   buttons.add(new Button("search","查看","rec080403","search(document.all.tableform)"));
  buttons.add(new Button("add","投诉登记","rec080401","tologin(document.all.tableform)"));
...
%>
<lemis:title title="机构日常投诉登记"/>
<lemis:query action="/Rec0803Action.do?method=enterqueryorgan"  editorMeta="editor" topic="查询条件"/>
<lemis:table topic="机构列表" action="/Rec0803Action.do" headerMeta="header" hiddenMeta="hidden"  mode="radio"/>
