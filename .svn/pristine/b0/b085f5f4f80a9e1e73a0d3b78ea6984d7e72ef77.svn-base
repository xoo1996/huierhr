...
<%
	...
	buttons.put("入库详情","detail(document.all.tableform)");
  		...
  		function detail() {
			...
			if(!t){
  			...
  			window.location.href = "/" + lemis.WEB_APP_NAME
  					+ "/task/TaskAction.do?method=inDetail&"
...
<lemis:body>
	...
	<lemis:query action="/TaskAction.do?method=query&order=in" editorMeta="editor"
		topic="查询条件" />
