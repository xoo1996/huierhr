<!--/recommendation/employassembly/ModEmptyPost.jsp-->
...
<html>
	...
	<lemis:body>
		<%
			...
			buttons.add(new Button("Btn_save","保 存", "rec070210", "save()"));
...
function zdgz(){
  ...
  function save(){
   ...
   if (!ok){
    ...
    obj.action= '<html:rewrite page="/Rec0702Action.do?method=modsaveEmptyPost"/>';
    obj.submit();
  }
