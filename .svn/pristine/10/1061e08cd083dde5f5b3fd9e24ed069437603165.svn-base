...
//维修表
public class Repair extends EntitySupport {
	...
	private String reppid;// 助听器型号，同时也是零件代码
...
*/	
	...
	public String getRepactionCode() {
		return repactionCode;
	}

	public void setRepactionCode(String repactionCode) {
		this.repactionCode = repactionCode;
	}
	...
	public Date getRepcusdt() {
		return repcusdt;
	}

	public void setRepcusdt(Date repcusdt) {
