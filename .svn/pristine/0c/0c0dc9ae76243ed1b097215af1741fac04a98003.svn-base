...
public class Task extends EntitySupport { 	
	...
	public Date getTsdfinish() {
		return tsdfinish;
	}
	public void setTsdfinish(Date tsdfinish) {
		this.tsdfinish = tsdfinish;
	}
