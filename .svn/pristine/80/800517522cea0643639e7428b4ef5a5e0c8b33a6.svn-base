...
<script src="/lemis/js/lemisTree.js"></script>
  ...
  <lemis:editorlayout/>
   ...
   <lemis:texteditor property="acb244" label="摊位号" maxlength="30" disable="true"  required="false"/> 
   </tr>
   <tr>
   <lemis:texteditor property="acb245" label="微机型号" maxlength="30" disable="true"  required="false"/>
    <lemis:texteditor property="aac003" label="姓名" maxlength="30" disable="true"  required="false"/>
    <lemis:formateditor mask="card" property="aac002" label="公民身份号码" required="false" disable="true"/>
   </tr>
   <tr> 
     <lemis:codelisteditor type="aac004" label="性别" required="false" isSelect="false" redisplay="false"/>
     <lemis:formateditor mask="date" property="aac006" label="出生年月" disable="true" required="false" format="true"/>
     <lemis:codelisteditor type="aac011" label="文化程度" required="false" isSelect="false" redisplay="false"/>
   </tr>
   <tr>
      <lemis:texteditor property="acb246" label="个人简历" maxlength="100"  disable="true" colspan="5"/> 
    </tr>  
    <tr>
    <lemis:formateditor mask="money" property="aab049" label="注册资金" disable="true" required="false" format="false" />
     ...
     <tr>
      <lemis:texteditor property="acb249" label="业务范围" maxlength="100"  disable="true" colspan="5"/> 
    </tr>  
     <tr>
