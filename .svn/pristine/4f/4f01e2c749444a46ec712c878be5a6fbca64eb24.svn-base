<!--sysmanager/param/EditCodeList.jsp-->
...
<lemis:body>
	<lemis:errors />
	<lemis:title title="修改代码" />
	<html:form action="/codeListAction.do" method="POST">
		<lemis:tabletitle title="代码信息" />
		<table class="tableInput">
			<lemis:editorlayout />
			<tr>
				<html:hidden property="baa109" value="1" />
				<lemis:texteditor property="aaa100" label="代码类别" required="true"
					disable="true" maxlength="6" />
				<lemis:texteditor property="aaa101" label="类别名称" required="true"
					disable="true" maxlength="50" />
				<lemis:texteditor property="aaa102" label="代码值" required="true"
					disable="true" maxlength="6" />
			</tr>
			<tr>
				<lemis:texteditor property="aaa103" label="代码名称" required="true"
...
<script language="javascript">
   ...
   if (!ok){
     ...
     obj.action= '<html:rewrite page="/codeListAction.do?method=updateaa10&"/>';
     obj.submit();
  }
</script>
