...
//单位变更信息表$bas
public class Cb02 extends EntitySupport {
    private String aaa021;//行政区划名称

    private String aaa130;//国别代码
    ...
    private String aab006;//工商登记执照种类

    private String aab007;//工商登记执照号码

    private Date aab008;//工商登记执照日期

    private Short aab009;//工商登记有效期限（年）

    private String aab010;//批准成立单位

    private Date aab011;//批准日期

    private String aab012;//批准文号

    private String aab013;//法定代表人

    private String aab014;//法定代表人公民身份号码

    private String aab015;//法定代表人电话
    ...
    private String aab023;//主管部门

    private String aab027;//支付开户银行行号

    private String aab028;//支付银行户名

    private String aab029;//支付银行基本帐号

    private String aab030;//税号

    private String aab031;//税务机构编码

    private String aab032;//税务机构名称

    private String aab034;//社会保险经办机构编码

    private Date aab036;//社会保险登记证发放日期

    private Date aab037;//税务证批准日期（国）

    private String aab039;//用工登记证号

    private String aab040;//工资基金使用手册编号

    private String aab041;//单位英文名称

    private String aab042;//单位简称

    private String aab043;//单位拼音码

    private String aab045;//主办部门

    private String aab046;//地税税号

    private String aab047;//地税税务机构名称

    private String aab048;//经营方式（正规五类企业）

    private String aab049;//注册资金

    private String aab052;//主营范围（正规五类企业）

    private String aab053;//兼营范围（正规五类企业）

    private String aab054;//产业类别

    private String aab056;//人员规模

    private String aab057;//事业单位类型

    private String aab301;//所在地行政区划代码

    private String aab341;//单位年检情况

    private String aab342;//单位级别

    private String aab343;//一级单位编号
    ...
    private String aae014;//传真

    private String aae015;//电子信箱

    private String aae016;//网址
    ...
    private String acb020;//变更编号

    private String bab055;//产业名称
    ...
    public Date getAab011() {
        return this.aab011;
    }

    public void setAab011(Date aab011) {
        this.aab011 = aab011;
    }
    ...
    public Date getAab036() {
        return this.aab036;
    }

    public void setAab036(Date aab036) {
        this.aab036 = aab036;
    }

    public Date getAab037() {
        return this.aab037;
    }

    public void setAab037(Date aab037) {
        this.aab037 = aab037;
    }
    ...
    public String getAab057() {
        return this.aab057;
    }

    public void setAab057(String aab057) {
        this.aab057 = aab057;
    }
    ...
    public String getAcb020() {
        return this.acb020;
    }

    public void setAcb020(String acb020) {
        this.acb020 = acb020;
    }

    public String getBab055() {
        return this.bab055;
    }

    public void setBab055(String bab055) {
        this.bab055 = bab055;
    }
