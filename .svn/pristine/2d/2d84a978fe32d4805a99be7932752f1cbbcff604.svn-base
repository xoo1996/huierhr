...
$(document).ready(function(){
	...
	if(grCli=="HC0001"||grCli=="admin"){
		...
		$("input[name=tmkshmk]").val("<%=dto.getBsc011()%>");
		$("input[name=tmkshmk]").attr("readonly","true");
...
<lemis:body>
	...
	<lemis:tabletitle title="外壳制作工作量统计" />
	<table class="TableInput">
		<lemis:editorlayout />
		<html:form action="/CustomizationAction.do?method=worknum1"
			method="POST">
			<tr>
				<lemis:texteditor property="tmkshmk" required="false" label="制作者编号"
					disable="false" />
	...
	<br/>
	<div align="right">
		<input type="button" name="openwin" value="&nbsp;打&nbsp;&nbsp;印&nbsp;" class='buttonGray' onclick="print(document.forms[0])"> 
