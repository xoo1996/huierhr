...
public class ModifyFunctionAction extends ActionSupport{
    private String className = this.getClass().getName();

  /**
   *调用FunctionFacade.modifyFunction()
   */
    public EventResponse perform(Event evt){
        ...
        try {
            ...
            //调用对应的Facade业务处理方法
            ResponseEnvelop resEnv = facade.modifyFunction(value);
    ...
    protected Object processBody(HashMap hashBody)throws ManageInputException{
        ...
        sysFunction.setFlag(TypeCast.stringToString((String)hashBody.get("flag"),"节点类型",false));
        ...
        sysFunction.setSignatureType(TypeCast.stringToString((String)hashBody.get("signatureType"),"证书类型",true));
        ...
        sysFunction.setTitle(TypeCast.stringToString((String)hashBody.get("Title"),"菜单标题",true));
