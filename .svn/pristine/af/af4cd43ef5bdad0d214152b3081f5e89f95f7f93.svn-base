...
function lgvag() {
	...
	function xiugai(obj){
		...
		{  
			...
			{
				obj.action = '<html:rewrite page="/CustomOrderAction.do?method=addClient&tp=earRep&type=firm&"/>' + getAlldata(obj);
			    obj.submit();
			}
		}
	}; 
...
<lemis:body>
	...
	<table class="tableInput">
		<lemis:editorlayout />
			<html:form action="/CustomOrderAction.do?method=addClient&tp=earRep&type=o" method="POST">
			<tr>
