...
/**
 * <p>Title: 日志管理-根据用户登录名查询日志列表</p>
 * <p>Description:Action </p>
 * @author zqb
 * @version 1.0
 */

public class FindByLoginNameAction extends ActionSupport{
    private String className = this.getClass().getName();

    /**
     * 调用LogFacade.findByUserid
     * @param evt
     * @return
     */
  public EventResponse perform(Event evt){
      ...
      try {
          ...
          //调用对应的Facade业务处理方法
          ResponseEnvelop resEnv = facade.findByUser(value);
  ...
  protected Object processBody(HashMap hashBody)throws ManageInputException{
      //check param
      String loginName = TypeCast.stringToString(
          (String)hashBody.get("userid"),"登录名",false);
      ...
      reqbody.put("loginName",loginName);
