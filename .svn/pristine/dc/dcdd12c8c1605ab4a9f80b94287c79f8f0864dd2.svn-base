...
public class StringInputWithTextAreaTag extends StringInputTagArea
{
        ...
        throws JspException
    {
        ...
        stringbuffer.append("\">");
        stringbuffer.append(super.renderStringInput(rowspan));
        stringbuffer.append(" </td>");
        //stringbuffer.append(super.getStringInputValue());
        ResponseUtils.write(pageContext, stringbuffer.toString());
        return 1;
    }

    public StringInputWithTextAreaTag()
    {
        colspan = "1";
    }
