 ...
 * @version 1.0
 */
package org.radf.apps.recommendation.employinvite.imp;
 ...
 * 委托招聘岗位信息管理
 */
public class Rec0402IMP extends IMPSupport implements Rec0402Facade {
	...
	public ResponseEnvelop modEmptyPost(RequestEnvelop request) {
		...
		Connection con = null;
		Rec0402Form result = new Rec0402Form();
		Ab01 ab01 = new Ab01();
		Cb20 cb20 = new Cb20();
		Cb21 cb21 = new Cb21();
		try {
			HashMap map = (HashMap) request.getBody();
			Rec0402Form form = (Rec0402Form) map.get("beo");
	...
	public ResponseEnvelop addEmptyPost(RequestEnvelop request) {
		...
		try {
			...
			HashMap map = (HashMap) request.getBody();
			Rec0402DTO dto = (Rec0402DTO) map.get("beo");
	...
	public ResponseEnvelop modsaveEmptyPost(RequestEnvelop request) {
		...
		try {
			HashMap map = (HashMap) request.getBody();
			Rec0402DTO input = (Rec0402DTO) map.get("beo");
