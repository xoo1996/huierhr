...
<script src="/lemis/js/lemisTree.js"></script>
  ...
  <lemis:editorlayout/>
   ...
   <tr>
    <lemis:texteditor property="acb243" label="核准证编号" maxlength="30" disable="false"  required="false"/>
   <lemis:texteditor property="aae005" label="联系电话" maxlength="30" disable="false"  required="false"/>
   ...
   <tr> 
     ...
     <lemis:formateditor mask="date" property="aac006" label="出生年月" disable="false" required="false" format="true"/>
