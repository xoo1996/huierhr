...
<%  
	...
	buttons1.add(new Button("zs","库存修正（直属店）","zsd000002","storage_add(document.all.tableform)"));
	buttons1.add(new Button("kz","库存明细（总部）","sto050002","storage_detail(document.all.tableform)"));
	buttons1.add(new Button("k","库存明细","zsd000001","storage_detail(document.all.tableform)"));
	buttons1.add(new Button("pk","盘库","zsd000003","panku(document.all.tableform)"));
...
<lemis:body>
	...
	<lemis:query action="/InStoreAction.do?method=queryStorage"
