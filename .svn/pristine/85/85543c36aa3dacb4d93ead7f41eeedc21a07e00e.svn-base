	...
	function saveData(obj) {
		...
		if (document.all("tmecls").value == 'new'
			...
			obj.action = "/" + lemis.WEB_APP_NAME
					+ "/earmould/EarMouldAction.do?method=saveNew";
		} else {
	...
	<table class="tableinput">
		...
		<html:form action="/EarMouldAction.do" method="POST">
			<tr>
				...
				<lemis:texteditor property="tmectnm" label="团体客户" required="true"
					disable="false" maxlength="20" />
			...
			<table class="tableinput">
				...
				<tr>
					<lemis:codelisteditor type="tmefree" isSelect="true" label="是否赠送"
						redisplay="true" required="true" />
					<lemis:codelisteditor type="tmecls" isSelect="true" label="制作类别"
						redisplay="true" required="true" />
					<lemis:texteditor property="fdtqnt" label="数量" required="true"
						disable="false" />
				</tr>
				<tr>
					<lemis:texteditor property="tment" label="备注" required="false"
						disable="false" />
