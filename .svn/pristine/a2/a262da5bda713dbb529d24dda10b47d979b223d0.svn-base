...
return newElm;}
this.elementCheckboxEvent = function(id, face) {
this._clearingHouse[id].checkboxEvent(face);}
...
eval(content[1]);}
 ...
 //add by chenkl 20040705
 document.all.item("dialog").style.display="none";
 document.all.item("rightLabel").style.display="block";
 document.all.item("rightSave").style.display="block";
 //add end
}
