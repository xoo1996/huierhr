...
//});
	...
	function saveData(obj) {
		...
		obj.action = '<html:rewrite href="/huiermis/product/ProductAction.do?method=saveModified&mark=make"/>';
		obj.submit();
	}
</script>
...
<lemis:body>
	...
	<table class="tableinput">
		<lemis:editorlayout />
		<html:form action="/ProductAction.do?method=saveModified&mark=make&"
			method="POST">
			<tr>
