...
public class SmartUpload
{
        ...
        throws SmartUploadException, IOException, ServletException
    {
        ...
        do
        {
            ...
            if(isFile)
            {
                com.jspsmart.upload.File1 newFile = new com.jspsmart.upload.File1();
	...
	public void downloadFile(String s, String s1, String s2, int i) throws ServletException, IOException, SmartUploadException
	{
     ...
     if(s1 == null)	 m_response.setContentType("application/x-msdownload");
     else
     if(s1.length() == 0)	 m_response.setContentType("application/x-msdownload");
     else m_response.setContentType(s1);
