...
public class Reservation extends EntitySupport {
	...
	private String rsvgctnm;//预约团体客户名称
	private String rsvgczhuanid;//转诊单位代码
	private String rsvgctzhuannm;//转诊单位名称
	private String rsvtodayid;//当天预约号
	private Date rsvqddate;//签到日期
	private String rsvnote;//预约备注
	private Date rsvdjdate;//预约登记日期
	
	private Date start;//预约日期从
	private Date end;//预约日期到
	//传递给singleclient
