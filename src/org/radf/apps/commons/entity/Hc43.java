...
//意愿一表 数据指标$obt
public class Hc43 extends EntitySupport {
    ...
    private String bhc431;//本次培训意愿编号

    private String bhc432;//是否要求免费

    private String bhc433;//其他要求
    ...
    public String getBhc431() {
        return this.bhc431;
    }

    public void setBhc431(String bhc431) {
        this.bhc431 = bhc431;
    }

    public String getBhc432() {
        return this.bhc432;
    }

    public void setBhc432(String bhc432) {
        this.bhc432 = bhc432;
    }

    public String getBhc433() {
        return this.bhc433;
    }

    public void setBhc433(String bhc433) {
        this.bhc433 = bhc433;
    }
